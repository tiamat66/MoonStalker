...
import si.vajnartech.moonstalker.androidsvg.CSSParser.*;
...
public class SVG
{
  ...
  // CSS rules
  private Ruleset cssRules = new CSSParser.Ruleset();
    ...
    void enumeratePath(PathInterface handler)
    {
      ...
      for (int commandPos = 0; commandPos < commandsLength; commandPos++) {
        ...
        default:
          ...
          handler.arcTo(coords[coordsPos++], coords[coordsPos++], coords[coordsPos++], largeArcFlag, sweepFlag,
                        coords[coordsPos++], coords[coordsPos++]);
        }
      }
    }
