...
import si.vajnartech.moonstalker.androidsvg.SVG.SvgElementBase;
/*
...
//         simpleSelectors.addedAttributeOrPseudo();
  ...
  private static boolean  ruleMatch(RuleMatchContext ruleMatchContext, Selector selector, int selPartPos, List<SVG.SvgContainer> ancestors, int ancestorsPos, SvgElementBase obj)
  {
    // We start at the last part of the simpleSelectors and loop back through the parts
    // Get the next simpleSelectors part
  ...
  private static int getChildPosition(List<SVG.SvgContainer> ancestors, int ancestorsPos, SvgElementBase obj)
  {
  ...
  private static boolean selectorMatch(RuleMatchContext ruleMatchContext, SimpleSelector sel, List<SVG.SvgContainer> ancestors, int ancestorsPos, SvgElementBase obj)
  {
